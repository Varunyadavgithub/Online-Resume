import Taniya_Webfix_Logo from "../assets/Taniya_Webfix_Logo_01.jpg";
import Western_Refrigeration_Logo from "../assets/Western_Refrigeration_Logo_02.png";

export const experienceData = [
  {
    logo: Western_Refrigeration_Logo,
    company: "Western Refrigeration Pvt. Ltd.",
    role: "MES Developer Trainee",
  ...
  },
  {
    ...
    type: "Onsite",
    points: [
      "Designed and developed responsive user interfaces using HTML, CSS, JavaScript, and React.js.",
      "Built dynamic and reusable React components to improve application scalability and maintainability.",
      "Participated in code reviews and collaborated with team members to improve development workflows.",
      "Worked on bug fixes and performance optimizations, enhancing overall user experience.",
      "Strengthened React.js and front-end development skills while working in a collaborative, mentorship-driven environment.",
    ],
  },
];
